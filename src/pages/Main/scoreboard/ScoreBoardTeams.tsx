...
export default function ScoreBoardTeams({ teams, loading, error }: ScoreBoardTeamsProps) {
      ...
      <AnimatePresence mode="popLayout">
        {teams.map((team, index) => (
          <motion.div
            ...
            className={`mx-auto flex items-center justify-between gap-3 border border-white/25 px-4 py-2 font-Shuriken normal-case tracking-normal text-white shadow-[0_4px_20px_rgba(0,0,0,0.25)] backdrop-blur-sm sm:px-6 sm:py-2.5 md:gap-6 md:px-8 ${rowWidthClass(index)}`}
          >
